...
Output: review1/ce3_joint_s345.json (incremental). Detached, multi-hour.
"""
...
HERE=OUTDIR; OUT=os.path.join(HERE,"ce3_joint_s345.json")
SEEDS=[3,4,5]; N_C=120; GAP_THR=3.0; EAH_STABLE=0.1; EAH_MAX=5.0
